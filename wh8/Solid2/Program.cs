...
class EmailSender
{
    ...
    public void SendSecondForm(Email email)
    {
        Console.WriteLine("To '" + email.To + "' From '" + email.From + "' was send theme: " + email.Theme);
    }
    public void SendAnotherForm(Email email)
    {
        /****/
    }
}
